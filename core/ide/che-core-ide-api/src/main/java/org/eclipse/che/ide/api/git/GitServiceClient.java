...
public interface GitServiceClient {
     ...
     * @param callback
     *
     * @deprecated instead of this method should use {@link GitServiceClient#remoteList(ProjectConfigDto, String, boolean)}
     */
     ...
     */
    Promise<List<Remote>> remoteList(ProjectConfigDto projectConfig, @Nullable String remoteName, boolean verbose);
     ...
     *         callback
     * @throws WebSocketException
     * @deprecated use {@link #push(ProjectConfigDto, List, String , boolean)}
     */
    @Deprecated
     ...
     *         disables the check. This can cause the remote repository to lose commits
     */
    Promise<PushResponse> push(ProjectConfigDto project,
                               List<String> refSpec,
                               String remote,
                               boolean force);
    /**
     ...
     * @param callback
     */
    void log(ProjectConfigDto project, List<String> fileFilter, boolean isTextFormat, AsyncRequestCallback<LogResponse> callback);
     ...
     *         project (root of GIT repository)
     * @param callback
     * @deprecated use {@link #status(ProjectConfigDto)}
     */
    @Deprecated
     ...
     */
    Promise<Status> status(ProjectConfigDto project);
