...
/**
 * Arguments holder for {@link org.eclipse.che.api.git.GitConnection#remoteUpdate(RemoteUpdateParams)}.
 *
 * @author Igor Vinokur
 */
public class RemoteUpdateParams {
    ...
    /**
     * Create new {@link RemoteUpdateParams} instance with empty parameters
     */
    public static RemoteUpdateParams create() {
        return new RemoteUpdateParams();
    }
