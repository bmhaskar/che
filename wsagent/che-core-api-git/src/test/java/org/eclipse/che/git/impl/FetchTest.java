...
public class FetchTest {
    ...
    public void testSimpleFetch(GitConnectionFactory connectionFactory)
        ...
        connection.commit(CommitParams.create().withMessage("fetch test"));
        //clone default repo into fetchRepo
        fetchConnection.clone(CloneParams.create().withRemoteUri(connection.getWorkingDir().getAbsolutePath())
        ...
        //when
        fetchConnection.fetch(FetchParams.create().withRemote(repository.getAbsolutePath()));
    ...
    public void testFetchBranch(GitConnectionFactory connectionFactory)
        ...
        connection.commit(CommitParams.create().withMessage("fetch test"));
        //clone default repo into fetchRepo
        fetchConnection.clone(CloneParams.create().withRemoteUri(repository.getAbsolutePath()));
        ...
        connection.add(AddParams.create().withFilePattern(Arrays.asList(".")));
        connection.commit(CommitParams.create().withMessage("fetch branch test"));
    ...
    public void testWhenThereAreNoAnyRemotes(GitConnectionFactory connectionFactory) throws Exception {
        ...
        //when
        connection.fetch(FetchParams.create());
    }
}
