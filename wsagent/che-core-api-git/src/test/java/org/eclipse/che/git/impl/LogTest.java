...
public class LogTest {
    ...
    public void testSimpleLog(GitConnectionFactory connectionFactory) throws GitException, IOException {
        ...
        connection.add(AddParams.create().withFilePattern(ImmutableList.of("README.txt")));
        connection.commit(CommitParams.create().withMessage("Second commit"));

        addFile(connection, "README.txt", "otherChanges");
        connection.add(AddParams.create().withFilePattern(ImmutableList.of("README.txt")));
        connection.commit(CommitParams.create().withMessage("Third commit"));
    ...
    public void testLogWithFileFilter(GitConnectionFactory connectionFactory) throws GitException, IOException {
        ...
        connection.add(AddParams.create().withFilePattern(ImmutableList.of("newFile.txt")));
        connection.commit(CommitParams.create().withMessage("Add newFile.txt"));
