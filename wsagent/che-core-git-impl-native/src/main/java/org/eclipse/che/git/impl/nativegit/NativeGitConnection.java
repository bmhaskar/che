...
public class NativeGitConnection implements GitConnection {
    ...
    public void cloneWithSparseCheckout(String directory, String remoteUrl, String branch) throws GitException, UnauthorizedException {
        ...
        */
        init(false);
        remoteAdd(RemoteAddParams.create().withName("origin").withUrl(remoteUrl));
        ...
        try {
            fetch(FetchParams.create().withRemote("origin"));
    ...
    public void clone(CloneParams params) throws UnauthorizedException, GitException {
        final String remoteUri = params.getRemoteUri();
